...
# Options: lorenz, California_Housing, AAPL, SnP, or crypto (or Motivational_Example for DEMO version!)
Option_Function = "lorenz" 
...
test_size_ratio = 0.9
min_width = 3
min_epochs = 1; min_epochs_classifier = 1
# Ablation Finess
N_plot_finess = 4
...
if trial_run == True:
    ...
    param_grid_FFNNs = {'batch_size': [16],
                    'epochs': [100],
                      ...
                      'height': [700], #200
                      'depth': [10], # changed by 2 to 1 (date 26/08/2022)
                      'input_dim':[1],
                      'output_dim':[1]}
    param_grid_Vanilla_Nets = {'batch_size': [16],
                    'epochs': [100],
                      'learning_rate': [0.01],
                      'height': [100,3,3,100],#36000
                      'depth': [4],
                      'input_dim':[1],
                      'output_dim':[1]}
