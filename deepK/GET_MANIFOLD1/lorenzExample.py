...
params['data_name'] = 'lorenzExample'
params['data_train_len'] = 1
params['len_time'] = 50 #artificial value
n = 3  # dimension of system (and input layer)
num_initial_conditions = 480  # per training file
params['delta_t'] = 0.01
...
params['num_passes_per_file'] = 10 #15 * 6 * 10
params['num_steps_per_batch'] = 5
params['learning_rate'] = 10 ** (-3)
params['batch_size'] = 120 #256
